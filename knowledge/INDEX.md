...
Every page under `pages/`. Match **Tags** against your task to decide what to load;
`check-knowledge` matches **Covers** against recently changed files.
...
Maintained by `check-knowledge` and `synthesize-knowledge`. These dates are what their
"has it been long enough" triggers read — without them the triggers have nothing to
evaluate.
